        ...
        .then( json => {
           ...
           for (let index =0; index < json.length; index++) {
               ...
               contenido = contenido + `<div class="card col-5 col-md-3 col-lg-2 m-1" > 
                                        ...
                                        </div><img src="${user.img}" alt="Imagen Digimon" class="card-img-bottom" width="100" height="100"><p>Nivel: ${user.level}</p>
                                       </div>`
           }
       ...
       .then( (json) => {
            ...
            for (let index =0; index < json.length; index++) {
               ...
               contenido = contenido + `   
                                        ...
                                        <div class="card col-5 col-md-3 col-lg-2 m-1" > 
                                         <div class="card-body "><p class="card-title">${digimon.name}</p><p class="card-text"></p> 
                                         </div><img src="${digimon.img}" alt="Imagen Digimon" class="card-img-bottom" width="100" height="100"><p>Nivel: ${digimon.level}</p>
                                         </div>`
